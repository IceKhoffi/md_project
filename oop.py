...
model_handler.save_data('oop_df.pkl')
#model_handler.save_tfidf_vector('oop_tfidf_vectorizer.pkl')
#model_handler.save_tfidf_matrix('oop_tfidf_matrix.pkl') 
model_handler.save_cosine_sim('oop_cosine_similarity.pkl')   